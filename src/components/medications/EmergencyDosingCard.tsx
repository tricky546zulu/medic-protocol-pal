    ...
    <Card className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 group overflow-hidden">
      <CardHeader className="p-4 bg-gray-50 border-b border-gray-100">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <CardTitle className="text-lg font-semibold text-gray-900 truncate flex-1">{dosing.indication}</CardTitle>
      ...
      <CardContent className="p-4">
        <div className="space-y-4">
          ...
          <div className="p-4 bg-red-50 rounded-lg border border-red-200">
            <h4 className="text-sm font-semibold text-red-800 mb-2 uppercase tracking-wide">🚨 Emergency Dose</h4>
            <p className="font-bold text-xl text-center text-red-900 bg-white p-3 rounded-lg border border-red-200">
              {dosing.dose}
            </p>
          </div>
          ...
          {dosing.concentration_supplied && (
            <div className="p-3 bg-blue-50 rounded-lg text-sm border border-blue-200">
              ...
              <span className="font-medium text-blue-900">{dosing.concentration_supplied}</span>
            </div>
          )}
